...
from cudet.core import (AnchorGenerator, multi_apply, anchor_target, delta2bbox,
                        multiclass_nms)
...
class AnchorHead(nn.Module):
    ...
    def get_anchors(self, featmap_sizes, img_metas):
        ...
        for i in range(num_levels):
            # Ni * Hi represent ith layer ,So anchors are (Ni * Hi * (scales*ratios),4)
        ...
        for img_id, img_meta in enumerate(img_metas):
            ...
            for i in range(num_levels):
                ...
                h, w, _ = img_meta['pad_shape']  # img may have pad
                # valid h is shape(after padding) / stride , and feat_H ,minimum in them are result.
    ...
    def loss(self,
        ...
        label_channels = self.cls_out_channels if self.use_sigmoid_cls else 1  # use sigmoid means predict classes, 1 means background and foreground.
        ...
        if cls_reg_targets is None:
            return None
        (label_list, label_weights_list, bbox_targets_list, bbox_weights_list,
